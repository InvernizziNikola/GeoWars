...
public class DBManager {
    ...
    public ArrayList DBSelectEnemy(String Enemy) {
        String SQLstring = "SELECT name,type,image,speed,maxHP,fireDelay,fireRange,difficultyGrade,spread,red,green,blue FROM Enemy where name = ?;";
        try {
            prep = this.conn.prepareStatement(SQLstring);
    ...
    public ArrayList DBSelectAllEnemys() {
        String SQLstring = "SELECT name,type,image,speed,maxHP,fireDelay,fireRange,difficultyGrade,spread,red,green,blue FROM Enemy;";
        try {
            prep = this.conn.prepareStatement(SQLstring);
        } catch (SQLException e) {
            System.out.println("error with preparing statment. Are you trying to hack us?");
