...
public class DBManager {
    ...
    public ArrayList DBselectHighscore(String Gamemode) {
        try {
            String SQLstring = "SELECT nameProfile,score FROM showHighscores where gamemode ='" + Gamemode + "'ORDER BY score DESC;";
            resultselect = DBconnect(SQLstring, true);
        } catch (Exception e) {
            System.out.println("Fout in select: " + e.getMessage());
        }
    ...
    public ArrayList DBselectTOP10Highscore(String Gamemode) {
        try {
            String SQLstring = "SELECT nameProfile,score FROM showHighscores where gamemode ='" + Gamemode + "' ORDER BY score DESC LIMIT 10;";
            resultselect = DBconnect(SQLstring, true);
        } catch (Exception e) {
            System.out.println("Fout in select: " + e.getMessage());
        }
